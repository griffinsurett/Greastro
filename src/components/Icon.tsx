...
function renderStringIcon(icon: string, size: keyof typeof sizeMap, className: string, color?: string, ariaLabel?: string) {
  // Check for emoji
...
export default function Icon({ 
  ...
  if (typeof icon === 'string') {
    return renderStringIcon(icon, size, className, color, ariaLabel);
  }

  // Object types - TypeScript narrows automatically
